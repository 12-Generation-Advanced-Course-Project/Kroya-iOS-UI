            ...
            ZStack {
                VStack {
                    ...
                    Button(action: {
                        ...
                        authVM.verifyOTPcodeForResetPassword(emailUser, otpCode)
                    }) {
                ...
                // Navigate to CreatePasswordStatic on OTP success
                NavigationLink(destination: CreatePasswordStatic(lang: $lang, authVM: authVM, Email: emailUser), isActive: $authVM.isOTPVerifiedForReset) {
                    EmptyView()
                }
                .hidden()
