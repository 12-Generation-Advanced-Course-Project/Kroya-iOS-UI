...
class AuthService {
    ...
    //MARK: SendOTP for Reset
    func sendOTPForSet(_ email: String, completion: @escaping (Result<SendOTPResponse, Error>) -> Void) {
        let url = Constants.KroyaUrlAuth + "send-otp"
        let parameters: [String: String] = ["email": email]
    ...
    func VerifyOTPCodeForReset(_ email: String, _ code: String, completion: @escaping (Result<VerificationCodeRequestResponse, Error>) -> Void) {
        let url = Constants.KroyaUrlAuth + "validate-otp"
        let parameters: [String: String] = ["email": email, "otp": code]
        print("URL: \(url)")
        print("Parameters: \(parameters)")
...
//    }
    ...
    // MARK: - Reset Password
       func resetPassword(email: String, newPassword: String, completion: @escaping (Result<ResetPasswordResponse, Error>) -> Void) {
           let url = "https://kroya-api-production.up.railway.app/api/v1/auth/reset-password"
